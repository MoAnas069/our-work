    ...
    <div className="w-full flex flex-col items-center sm:items-start justify-center gap-3 sm:gap-6 select-none font-mono">
      ...
      <div className="w-full max-w-xl border border-white/[0.06] bg-white/[0.015] hover:border-white/[0.12] hover:bg-white/[0.025] rounded-2xl sm:rounded-3xl p-3.5 sm:p-6 lg:p-8 backdrop-blur-xl transition-all duration-300 relative overflow-hidden shadow-2xl">
        ...
        <div className={`transition-all duration-300 ${fade ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          ...
          {/* Technologies Used */}
          <div className="flex flex-col gap-1.5 sm:gap-2 mb-3 sm:mb-8">
            <span className="text-[9px] sm:text-[10px] text-white/40 uppercase tracking-widest font-mono flex items-center gap-1.5">
              <Code className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-neonGreen/70" /> Tech Stack
            </span>
            <div className="flex flex-wrap gap-1 sm:gap-2">
              {displayProject.technologies.map((tech, idx) => (
                <span
                  key={idx}
                  className="text-[10px] sm:text-xs font-sans px-2 py-0.5 sm:px-3 sm:py-1 rounded-md bg-white/[0.04] border border-white/[0.06] text-white/80"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="flex flex-row gap-2 sm:gap-3">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 bg-neonGreen text-black font-extrabold uppercase tracking-wider text-[10px] sm:text-xs py-2.5 sm:py-3.5 px-3 sm:px-6 rounded-full hover:bg-white hover:text-black hover:shadow-[0_0_25px_rgba(92,255,61,0.4)] transition-all duration-300 group"
            >
              Live Demo
            ...
            <a
              ...
              className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 border border-white/20 hover:border-white/80 text-white font-bold uppercase tracking-wider text-[10px] sm:text-xs py-2.5 sm:py-3.5 px-3 sm:px-6 rounded-full hover:bg-white/5 transition-all duration-300"
            >
              Case Study
            </a>
          </div>
